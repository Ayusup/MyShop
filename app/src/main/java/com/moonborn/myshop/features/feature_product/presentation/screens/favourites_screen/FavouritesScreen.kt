package com.moonborn.myshop.features.feature_product.presentation.screens.favourites_screen
...
import com.moonborn.myshop.features.feature_product.presentation.products.components.ProductsInFavourites
...
fun LazyListScope.ProductsList(modifier: Modifier = Modifier){
    ...
    items(productList().size) { index ->
        ...
        ProductsInFavourites(name = product.name, price = product.price)
    }
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FavouritesScreen(parentPadding: PaddingValues, modifier: Modifier = Modifier, function: () -> Unit) {
